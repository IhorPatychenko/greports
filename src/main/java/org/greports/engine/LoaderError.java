...
public class LoaderError implements Serializable {
    ...
    public LoaderError(String sheetName, Integer rowIndex, Integer columnIndex, String columnTitle, String errorMsg, Serializable errorValue) {
    ...
    public LoaderError(Cell cell, String columnTitle, String errorMsg, final Serializable errorValue) {
